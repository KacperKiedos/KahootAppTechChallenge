package pl.kacperkiedos.kahootapptechchallenge.quiz.screen
...
import pl.kacperkiedos.kahootapptechchallenge.quiz.widgets.Footer
import pl.kacperkiedos.kahootapptechchallenge.quiz.widgets.Question
import pl.kacperkiedos.kahootapptechchallenge.quiz.widgets.answer.AnswersSection
import pl.kacperkiedos.kahootapptechchallenge.quiz.widgets.header.QuestionHeader
import pl.kacperkiedos.kahootapptechchallenge.ui.widgets.ErrorMessage
...
internal fun QuizOngoingScreen(
    ...
    Column(
        ...
        Footer(
            questionState = quizScreenStateData.questionState,
            onTimerComplete = {
                onEvent(QuizScreenEvent.QuestionTimerCompleted)
            },
